    ...
    case 'safari':
      if (navigator.webkitGetUserMedia) {
          ...
          if (!pluginShim||!pluginShim.shimPeerConnection) {
              logging('IE / Safari Plugin shim is not included in this adapter release.');
              return;
            }
...
},{"./chrome/chrome_shim":4,"./edge/edge_shim":6,"./firefox/firefox_shim":9,"./plugin/plugin_shim":12,"./safari/safari_shim":13,"./utils":14}],4:[function(require,module,exports){
...
},{"../utils.js":14,"./getusermedia":5}],5:[function(require,module,exports){
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
},{"../utils.js":14}],6:[function(require,module,exports){
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
},{"../utils":14,"./getusermedia":7,"sdp":2}],7:[function(require,module,exports){
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
},{"../utils":14,"./getusermedia":10}],10:[function(require,module,exports){
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
},{"../utils.js":14}],12:[function(require,module,exports){
...
*/
  ...
  shimPeerConnection: function() {
    ...
    window.RTCPeerConnection = function(pcConfig, pcConstraints) {
      ...
      this._pc = getPlugin().createPeerConnection(pcConfig, pcConstraints);
      this.onicecandidate = null;
      this.onaddstream = null;
      this.ontrack = null;
      this.onremovestream = null;
      ...
      //var origGetStats = this._pc.getStats.bind(this._pc);
      var origGetStats = this._pc.getStats;
      this.getStats = function(selector, successCallback, errorCallback) {
      ...
      //var origCreateOffer = this._pc.createOffer.bind(this._pc);
      var origCreateOffer = this._pc.createOffer;
      this.createOffer = function(successCallback, failureCallback, rtcOptions) {
        var self = this;
        var args = arguments;

        // If selector is a function then we are in the old style stats so just
        // pass back the original createOffer format to avoid breaking old users.
        if (arguments.length > 0 && typeof rtcOptions === 'object') {
          return origCreateOffer(successCallback, failureCallback, rtcOptions);
        }

        // promise-support
        return new Promise(function(resolve, reject) {
          //if (args.length === 1 && typeof rtcOptions === 'object') {
            origCreateOffer.apply(self._pc, [resolve, reject]);
          //} else {
          //    logging("CreateOffer promise failed!!!");
          //}
        }).then(successCallback, failureCallback);
      };
      
      //var origCreateAnswer = this._pc.createAnswer.bind(this._pc);
      var origCreateAnswer = this._pc.createAnswer;
      this.createAnswer = function(successCallback, failureCallback, rtcOptions) {
        var self = this;
        var args = arguments;
        ...
        // pass back the original createOffer format to avoid breaking old users.
        if (arguments.length > 0 && typeof rtcOptions === 'object') {
          return origCreateAnswer(successCallback, failureCallback, rtcOptions);
        }

        // promise-support
        return new Promise(function(resolve, reject) {
          //if (args.length === 1 && typeof rtcOptions === 'object') {
            origCreateAnswer.apply(self._pc, [resolve, reject]);
          //} else {
          //    logging("CreateAnswer promise failed!!!");
          //}
        }).then(successCallback, failureCallback);
      };

      //var origSetLocalDescription = this._pc.setLocalDescription.bind(this._pc);
      var origSetLocalDescription = this._pc.setLocalDescription;
      this.setLocalDescription = function(description, successCallback, failureCallback) {
        ...
        if (arguments.length > 1 /*&& typeof description === 'object'*/) {
          return origSetLocalDescription(description, successCallback, failureCallback);
        }

        // promise-support
        return new Promise(function(resolve, reject) {
            origSetLocalDescription.apply(self._pc, [resolve, reject]);
        }).then(successCallback, failureCallback);
      };

      //var origSetRemoteDescription = this._pc.setRemoteDescription.bind(this._pc);
      var origSetRemoteDescription = this._pc.setRemoteDescription;
      this.setRemoteDescription = function(description, successCallback, failureCallback) {
        ...
        // pass back the original createOffer format to avoid breaking old users.
        if (arguments.length > 1 /*&& typeof description === 'object'*/) {
          return origSetRemoteDescription(description, successCallback, failureCallback);
        }

        // promise-support
        return new Promise(function(resolve, reject) {
            origSetRemoteDescription.apply(self._pc, [resolve, reject]);
        }).then(successCallback, failureCallback);
      };

      //var origAddIceCandidate = this._pc.addIceCandidate.bind(this._pc);
      var origAddIceCandidate = this._pc.addIceCandidate;
      this.addIceCandidate = function(candidate, successCallback, failureCallback) {
        ...
        // If selector is a function then we are in the old style stats so just
        // pass back the original createOffer format to avoid breaking old users.
        if (arguments.length > 0 && typeof candidate === 'object') {
          return origAddIceCandidate(candidate);
        }

        // promise-support
        return new Promise(function(resolve, reject) {
          //if (args.length === 1 && typeof candidate === 'object') {
            origAddIceCandidate.apply(self._pc, [resolve, reject]);
          //} else {
          //    logging("setLocalDescription promise failed!!!");
          //}
        }).then(successCallback, failureCallback);
      };

      this.addStream = function (stream, constraints) { this._pc.addStream(stream, constraints); };
      this.getRemoteStreams = function () { return this._pc.getRemoteStreams(); };
      this.getLocalStreams =  function () { return this._pc.getLocalStreams(); };
      //pc.setLocalDescription = this._pc.setLocalDescription;
      //pc.setRemoteDescription = this._pc.setRemoteDescription;
      this._pc.onicecandidate = this.onicecandidate;
      this._pc.onaddstream = this.onaddsrteam;


    };
//    window.RTCPeerConnection.prototype = {createOffer: this.cretaeOffer, createAnswer: this.createAnswer };
/*
    ['createOffer', 'createAnswer'].forEach(function(method) {
      var nativeMethod = this.prototype[method];
...
/*
    ...
    if (true) {
      ['setLocalDescription', 'setRemoteDescription', 'addIceCandidate']
          .forEach(function(method) {
            var nativeMethod = getPlugin().RTCPeerConnection.prototype[method];
            getPlugin().RTCPeerConnection.prototype[method] = function() {
              var args = arguments;
              var self = this;
              var promise = new Promise(function(resolve, reject) {
                nativeMethod.apply(self, [args[0], resolve, reject]);
...
module.exports = {
  ...
  shimPeerConnection: pluginShim.shimPeerConnection,
  shimGetUserMedia: require('./getusermedia'),
...
},{"../es6-promise.min.js":8,"../utils.js":14,"./getusermedia":11}],13:[function(require,module,exports){
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
